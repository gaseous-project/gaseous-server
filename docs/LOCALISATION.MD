...
|------|--------------|-------------|------|--------|---------------|-------|
| en-AU | English (Australia) | English (Australia) | Overlay | en | pluralRule | Regional spelling |
...
| es-VE | Español (Venezuela) | Español (Venezuela) | Overlay | es | pluralRule |  |<!-- LOCALE_TABLE_END -->
