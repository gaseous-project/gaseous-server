...
namespace gaseous_server.Classes
{
	...
	public class ImportGame
	{
        ...
        public static void Rematcher()
        {
            ...
            Database db = new Database(Database.databaseType.MySql, Config.DatabaseConfiguration.ConnectionString);
            string sql = "SELECT * FROM Games_Roms WHERE (PlatformId = 0 OR GameId = 0 OR MetaddataSource = 0) AND (LastMatchAttemptDate IS NULL OR LastMatchAttemptDate < @lastmatchattemptdate) LIMIT 100;";
            Dictionary<string, object> dbDict = new Dictionary<string, object>();
