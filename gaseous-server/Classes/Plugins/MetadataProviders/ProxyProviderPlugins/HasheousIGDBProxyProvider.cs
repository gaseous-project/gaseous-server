    ...
    public class HasheousIGDBProxyProvider : IProxyProvider
    {
        ...
        public async Task<T?> GetEntityAsync<T>(string itemType, long id) where T : class
        {
            ...
            else
            {
                ...
                // convert igdb endpoint names to type names
                Dictionary<string, string> itemTypeCorrections = new Dictionary<string, string>
                {
                    ...
                    { "game_engine_logos", "gameenginlogo" },
                    ...
                    { "game_version_features", "gameversionfeature" },
                    { "game_version_feature_values", "gameversionfeaturevalue" },
