class Filtering {
    ...
    BuildFilterTable(filter) {
        ...
        panel.appendChild(this.#BuildBasicPanel(window.lang.translate('filtering.title_search'), true, searchCollapsed, this.#BuildStringPanel('search', window.lang.translate('filtering.title_search')), null));
        ...
        panel.appendChild(this.#BuildBasicPanel(window.lang.translate('filtering.settings'), true, settingsCollapsed, this.#BuildCheckList('settings', [
            {
                "id": "hasSavedGame",
        ...
        panel.appendChild(this.#BuildBasicPanel(window.lang.translate('filtering.platforms'), true, platformsCollapsed, this.#BuildCheckList("Platforms", filter["platforms"], true), null));
        ...
        panel.appendChild(this.#BuildBasicPanel(window.lang.translate('filtering.genres'), true, genresCollapsed, this.#BuildCheckList("Genres", filter["genres"], true), null));
        ...
        panel.appendChild(this.#BuildBasicPanel(window.lang.translate('filtering.themes'), true, themesCollapsed, this.#BuildCheckList("Themes", filter["themes"], true), null));
        ...
        panel.appendChild(this.#BuildBasicPanel(window.lang.translate('filtering.release_year'), true, releaseYearCollapsed, this.#BuildRangePanel('releaseyear', window.lang.translate('filtering.release_year'), 1960, new Date().getFullYear()), null));
        ...
        panel.appendChild(this.#BuildBasicPanel(window.lang.translate('filtering.players'), true, playersCollapsed, this.#BuildCheckList("Players", filter["gamemodes"], true), null));
        ...
        panel.appendChild(this.#BuildBasicPanel(window.lang.translate('filtering.player_perspectives'), true, perspectivesCollapsed, this.#BuildCheckList("perspectives", filter["playerperspectives"], true), null));
        ...
        panel.appendChild(this.#BuildBasicPanel(window.lang.translate('filtering.age_groups'), true, ageGroupsCollapsed, this.#BuildCheckList("ageGroups", filter["agegroupings"], true), null));
        ...
        panel.appendChild(this.#BuildBasicPanel(window.lang.translate('filtering.user_rating'), true, userRatingCollapsed, this.#BuildRangePanel('userrating', window.lang.translate('filtering.user_rating'), 0, 100), null));
        ...
        panel.appendChild(this.#BuildBasicPanel(window.lang.translate('filtering.user_votes'), true, userVoteCountCollapsed, this.#BuildRangePanel('uservotecount', window.lang.translate('filtering.user_votes'), 0, 1000000), null));
